 ...
 */
class getAxelControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\AxelController' shared autowired service.
     *
     * @return \App\Controller\AxelController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AxelController.php';

        $container->services['App\\Controller\\AxelController'] = $instance = new \App\Controller\AxelController();
        ...
        ]))->withContext('App\\Controller\\AxelController', $container));
